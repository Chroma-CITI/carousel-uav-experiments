...
ros2 run offboard_control uwb_formation --ros-args -p robot_id:=$drone2_number --log-level SimpleControl:=debug & #1>$ROS_WS/results/$experience_name/control/ros2_node_follower.log 2>&1 &
